        ...
        <section className="mt-8 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {products?.map((product, index) => (
                    <Link to={`/product/details/${product?._id}`} key={product?._id || index} className="shadow-md border border-gray-300 rounded-md hover:shadow-lg transition-shadow duration-300 cursor-pointer">
