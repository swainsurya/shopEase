...
const HeroSection = () => {
  ...
  return (
    <section className="w-full h-[300px] md:h-[750px] bg-gradient-to-r from-black to-indigo-900 flex items-center justify-center text-white text-center relative overflow-hidden">
      {/* Banner Image */}
      <img
